...
This project was created for my final in Internet of Things (CSCI 268) at Clark University.
...
Each command is a two-byte value that is sent using the NEC data-link layer protocol built-in to the Arduino-IRremote library.
...
Middlebox code was provided for the class by <a href="https://www.garyholness.com">Dr. Gary Holness,</a> with some modifications to work with my system.
